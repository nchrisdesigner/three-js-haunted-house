 ...
 */
// Ambient light
const ambientLight = new THREE.AmbientLight('#86cdff', 0.35)
 ...
 * Fog
 */
// scene.fog = new THREE.Fog('#04343f', 10, 15)
scene.fog = new THREE.FogExp2('#04343f', 0.04)
...
const tick = () => {
    ...
    ghost1.position.y = Math.sin(ghost1Angle) * Math.sin(ghost1Angle)
    const ghost2Angle = -elapsedTime * 0.34
    ghost2.position.x = Math.cos(ghost2Angle) * 5
    ghost2.position.z = Math.sin(ghost2Angle) * 5
    ghost2.position.y = Math.sin(ghost2Angle) * Math.sin(ghost2Angle)
    const ghost3Angle = elapsedTime * 0.19
    ghost3.position.x = Math.cos(ghost3Angle) * 6
    ghost3.position.z = Math.sin(ghost3Angle) * 6
    ghost3.position.y = Math.sin(ghost3Angle) * Math.sin(ghost3Angle)
